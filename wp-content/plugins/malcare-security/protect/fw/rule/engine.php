...
if (!class_exists('MCProtectFWRuleEngine_V636')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V636 {
	use MCProtectFWRuleStringFunc_V636;
	use MCProtectFWRuleArrayFunc_V636;
	use MCProtectFWRuleMiscFunc_V636;
	use MCProtectFWRuleRequestFunc_V636;
	use MCProtectFWRuleWPFunc_V636;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V636::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V636 $e) {
			$this->error = $e;
		}
	}
