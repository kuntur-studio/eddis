...
function edd_register_theme_options() {
	...
	Container::make( 'theme_options', 'Configuración General')
		...
		->add_tab('Widgets', [
			Field::make('separator', 'branches_widget_separator', 'Widget de Sedes'),
			...
			Field::make('separator', 'product_page_separator', 'Página de Producto'),
			// Widget de Banner Inferior
			Field::make('separator', 'product_banner_widget_separator', 'Banner Inferior'),
			...
			Field::make('image', 'product_banner_lg', 'Banner para pantallas LG (≥1200px)')
				->set_value_type('url')
				->help_text('Tamaño recomendado: 1200px de ancho'),
			Field::make('image', 'product_banner_md', 'Banner para pantallas MD (≥768px)')
				->set_value_type('url')
				->help_text('Tamaño recomendado: 768px de ancho'),
			Field::make('image', 'product_banner_sm', 'Banner para pantallas SM (<768px)')
				->set_value_type('url')
