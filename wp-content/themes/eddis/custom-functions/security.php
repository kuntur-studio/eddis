...
// Filtro para evitar spam en búsquedas del frontend
add_filter('init', function() {
	// Solo aplica en el frontend
	if (!is_admin()) {
		global $wp;
		$wp->add_query_var('busqueda');
